...
//    
    @Query(value = "select b from Question b where b.name like %:name%")
    List<Question> findByNameMatch(@Param("name") String name);
    
    
    @Query(value = "select b from Question b where b.name=:qname")
    Question findByName(@Param("qname") String name);
//    
