 ...
 */
@Repository
public interface MemberRecruitmentService extends JpaRepository<MemberRecruitment, Integer> {
...
//    
    @Query(value = "select b from MemberRecruitment b where b.name like %:name%")
    List<MemberRecruitment> findByNameMatch(@Param("name") String name);
    
    
    @Query(value = "select b from MemberRecruitment b where b.name=:qname")
    MemberRecruitment findByName(@Param("qname") String name);
//    
