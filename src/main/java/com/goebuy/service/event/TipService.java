 ...
 */
@Repository
public interface TipService extends JpaRepository<Tip, Integer> {
...
//    
    @Query(value = "select b from Tip b where b.name like %:name%")
    List<Tip> findByNameMatch(@Param("name") String name);
    
    
    @Query(value = "select b from Tip b where b.name=:qname")
    Tip findByName(@Param("qname") String name);
//    
