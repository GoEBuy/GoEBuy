...
//    
    @Query(value = "select b from Tag b where b.name like %:name%")
    List<Tag> findByNameMatch(@Param("name") String name);
    
    
    @Query(value = "select b from Tag b where b.name=:qname")
    Tag findByName(@Param("qname") String name);
//    
